...
<div role="status" className="absolute top-1/2 left-1/2">
    <svg aria-hidden="true" className="h-[50px] w-[50px] md:w-[100px] md:h-[100px] mr-2 text-white animate-spin dark:text-white fill-blue-800" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
